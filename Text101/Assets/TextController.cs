...
public class TextController : MonoBehaviour {
	...
	void Update () { // Keeps the game in the right state
		print (myState);
		...
		else if (myState == State.stairs_2) 	{stairs_2();}
		...
		else if (myState == State.in_closet) 	{in_closet();}
	...
	void mirror() {
		...
		if 		(Input.GetKeyDown(KeyCode.T)) 	{myState = State.cell_mirror;}
	...
	void lock_1() {
		...
		else if (Input.GetKeyDown(KeyCode.R)) 	{myState = State.cell_mirror;}
	}
	...
	void in_closet() {
		...
		else if (Input.GetKeyDown(KeyCode.D)) 	{myState = State.corridor_3;}
	}
	...
	void corridor_3() {
		...
		else if (Input.GetKeyDown(KeyCode.U))	{myState = State.in_closet;}
	}
	...
	void corridor_2() {
		...
		if 		(Input.GetKeyDown(KeyCode.C)) 	{myState = State.in_closet;}
		else if (Input.GetKeyDown(KeyCode.S)) 	{myState = State.stairs_2;}
	}
	...
	void corridor_1() {
		...
		if 		(Input.GetKeyDown(KeyCode.P)) 	{myState = State.in_closet;}
	...
	void floor () {
		...
		if 		(Input.GetKeyDown(KeyCode.R)) 	{myState = State.corridor_0;}
		else if (Input.GetKeyDown(KeyCode.H)) 	{myState = State.corridor_1;}
	}	
